...
#include "midend/support/Ref.hpp"
#include "midend/support/SparseStorage.hpp"
...
public:
  ...
  virtual std::set<const Array *> getRelatedArrays() const {
    return {};
  }

  static bool classof(const SymbolicSource *) {
    return true;
  }
  unsigned hash() const {
    return hashValue;
...
public:
  ...
  ConstantSource(SparseStorage<ref<ConstantExpr>> _constantValues) : constantValues(std::move(_constantValues)) {
  ...
  static bool classof(const ConstantSource *) {
    return true;
  }
...
public:
  ...
  UninitializedSource(unsigned version, const KInstruction *allocSite) : version(version), allocSite(allocSite) {
  }

  Kind getKind() const override {
    return Kind::Uninitialied;
  }
  ...
  static bool classof(const UninitializedSource *) {
    return true;
  }
...
public:
  ...
  SymbolicSizeConstantAddressSource(unsigned _version, const KValue *_allocSite, ref<Expr> _size)
      : version(_version), allocSite(_allocSite), size(_size) {
  }

  Kind getKind() const override {
    return Kind::SymbolicSizeConstantAddress;
  }
...
public:
  ...
  MakeSymbolicSource(const std::string &_name, unsigned _version) : name(_name), version(_version) {
  }
  Kind getKind() const override {
    return Kind::MakeSymbolic;
  }
  virtual std::string getName() const override {
    return "makeSymbolic";
  }
  ...
  static bool classof(const MakeSymbolicSource *) {
    return true;
  }
...
public:
  ...
  static bool classof(const SymbolicSource *S) {
    return S->getKind() == Kind::LazyInitializationAddress || S->getKind() == Kind::LazyInitializationSize ||
  ...
  virtual int internalCompare(const SymbolicSource &b) const override {
    ...
    const LazyInitializationSource &lib = static_cast<const LazyInitializationSource &>(b);
...
public:
  LazyInitializationAddressSource(ref<Expr> pointer) : LazyInitializationSource(pointer) {
  }
  Kind getKind() const override {
    return Kind::LazyInitializationAddress;
  }
  virtual std::string getName() const override {
  ...
  static bool classof(const LazyInitializationAddressSource *) {
    return true;
  }
};
...
public:
  LazyInitializationSizeSource(const ref<Expr> &pointer) : LazyInitializationSource(pointer) {
  }
  Kind getKind() const override {
    return Kind::LazyInitializationSize;
  }
  virtual std::string getName() const override {
  ...
  static bool classof(const LazyInitializationSizeSource *) {
    return true;
  }
};
...
public:
  LazyInitializationContentSource(ref<Expr> pointer) : LazyInitializationSource(pointer) {
  }
  Kind getKind() const override {
    return Kind::LazyInitializationContent;
  }
  virtual std::string getName() const override {
  ...
  static bool classof(const LazyInitializationContentSource *) {
    return true;
  }
};
...
public:
  ...
  ArgumentSource(const llvm::Argument &_allocSite, int _index, const KModule *km)
  ...
  static bool classof(const ArgumentSource *S) {
    return true;
  }
...
public:
  ...
  InstructionSource(const llvm::Instruction &_allocSite, int _index, const KModule *km)
      : ValueSource(_index, km), allocSite(_allocSite) {
  }
  ...
  static bool classof(const InstructionSource *S) {
    return true;
  }
...
public:
  ...
  static bool classof(const IrreproducibleSource *) {
    return true;
  }
  ...
  virtual int internalCompare(const SymbolicSource &b) const override {
    ...
    const IrreproducibleSource &irb = static_cast<const IrreproducibleSource &>(b);
    if (name != irb.name) {
...
public:
  ...
  static bool classof(const AlphaSource *) {
    return true;
  }
...
public:
  ...
  MockSource(const KModule *_km, const llvm::Function &_function) : km(_km), function(_function) {
  }
...
public:
  ...
  MockNaiveSource(const KModule *km, const llvm::Function &function, unsigned _version)
      : MockSource(km, function), version(_version) {
  }

  [[nodiscard]] Kind getKind() const override {
    return Kind::MockNaive;
  }
...
public:
  ...
  MockDeterministicSource(const KModule *_km, const llvm::Function &_function, const std::vector<ref<Expr>> &_args);
