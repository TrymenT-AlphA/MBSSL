...
public:
  ...
  virtual void enterQual_identifier(SMTLIBv2Parser::Qual_identifierContext *ctx) = 0;
  virtual void exitQual_identifier(SMTLIBv2Parser::Qual_identifierContext *ctx) = 0;
